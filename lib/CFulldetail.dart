...
class CFulldetail extends StatefulWidget {
  final Map data;
  const CFulldetail({Key? key, required this.data}) : super(key: key);

  @override
  _CFulldetailState createState() => _CFulldetailState();
}

class _CFulldetailState extends State<CFulldetail> {
  @override
